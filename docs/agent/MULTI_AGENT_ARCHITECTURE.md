...
| 项目 | 状态 | 说明 |
|------|------|------|
| 经验推送机制 | ✅ Done（见 docs/plans/2026-03-25--experience-push-mechanism.md） | #64 CLOSED |
| 通讯延迟处理 | ✅ Done（见 docs/plans/2026-03-25--communication-delay-strategy.md） | #65 CLOSED |
| Agent 生命周期 | ✅ Done（见 docs/plans/2026-03-25--agent-lifecycle-state-machine.md） | #66 CLOSED |

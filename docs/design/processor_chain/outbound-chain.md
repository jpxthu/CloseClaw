...
出站 Processor 链在 LLM 生成响应后解析 DSL 指令，完成内容变换后交付渲染。Gateway 从 Session 读取 ContentBlock[]（定义见 [common ContentBlock](../common/shared-types.md#contentblock)）构造 [ProcessedMessage](../common/shared-types.md#processedmessage) 传入链。

...
terminal 渠道 NormalizedMessage 取值：platform="terminal"、sender_id=系统UID、peer_id="cli"、account_id="owner"、content=原始输入、message_type=text。消息过滤规则与其他渠道一致：空内容不产出 NormalizedMessage。

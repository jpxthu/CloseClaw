...
- 压缩结果为一条 boundary 消息，包含对话的结构化摘要（TODO：参考 OpenClaw 行动导向的 6 维度结构——Goal / Constraints / Progress / Key Decisions / Next Steps / Critical Context，替代当前 Claude Code 的 9 维度）

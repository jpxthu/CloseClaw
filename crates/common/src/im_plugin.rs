...
pub struct NormalizedMessage {
    ...
    /// Trace ID for distributed tracing across message lifecycle.
    ///
    /// Generated by the IM adapter at webhook arrival, formatted as
    /// `{platform}-{timestamp_ms}-{uuid_v4}`. Used to correlate log events
    /// across modules.
    #[serde(default)]
    pub trace_id: String,
}

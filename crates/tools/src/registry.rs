...
/// hidden from the agent's tool list. Plan-specific tools (ModeExecutionTrigger)
/// remain visible for plan execution.
///
...
const PLAN_MODE_ALWAYS_VISIBLE: &[&str] = &[
    ...
    "ModeExecutionTrigger", // trigger execution from Plan Mode

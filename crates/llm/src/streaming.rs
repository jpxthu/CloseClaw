...
//! error notifications as the underlying [`crate::UnifiedChatClient`]
//! produces [`crate::StreamEvent`]s. Implementations forward these to
...
/// [`crate::StreamEvent`]s arrive; it never inspects the concrete
/// transport.
///
/// ## Contract
///

...
//!
//! The actual streaming transport (`send_streaming`) lives in [`crate::glm`]
//! which produces [`RawSseChunk`][crate::types::RawSseChunk] via
//! [`SseStream`][crate::provider::SseStream]. This module provides

...
impl IMPlugin for CapturingPlugin {
    ...
    fn handle_stream_event(
        ...
        self.streaming_renderer()
            .expect("CapturingPlugin has no streaming renderer")
            .lock()
...
impl IMPlugin for FailingPlugin {
    ...
    fn handle_stream_event(
        ...
        self.streaming_renderer()
            .expect("FailingPlugin has no streaming renderer")
            .lock()
            .expect("FailingPlugin streaming renderer lock poisoned")
            .handle_event(event)
    }

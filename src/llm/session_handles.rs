...
pub(crate) trait KillHandle: Send + Sync {
...
impl ConversationSession {
    ...
    pub(crate) fn register_tool_handle(
        &self,
    ...
    /// double-unregistered).
    pub(crate) fn unregister_tool_handle(&self, call_id: &str) {
        let mut map = self
            .tool_handles
            .write()
            .expect("tool_handles lock poisoned");
    ...
    pub(crate) fn register_child_handle(
        &self,
    ...
    pub(crate) fn unregister_child_handle(&self, child_id: &str) {
        let mut map = self
            .child_handles
            .write()
            .expect("child_handles lock poisoned");
    ...
    pub(crate) async fn stop(&self, cascade: bool) {

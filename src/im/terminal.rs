...
//!
//! All rendering logic is inline in this module.  The plugin overrides
//! [`IMPlugin`] hook methods for code blocks, markdown, and horizontal rules.
...
///
/// Wraps [`TerminalAdapter`] (stdin input) and provides ANSI-aware rendering
/// via the [`IMPlugin`] hook methods (`render_code_block`, `render_markdown`,
/// `render_hr`).  The default [`render`](IMPlugin::render) pipeline dispatches
/// to these hooks.

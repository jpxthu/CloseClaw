...
use crate::llm::session::KillHandle;
...
/// Kill adapter for a *background* task managed by
    ...
    fn kill(&self) -> io::Result<()> {
        ...
        match tokio::runtime::Handle::try_current() {
            Ok(handle) => {
                ...
                handle
                    .block_on(self.bg_manager.kill(&self.task_id))
